...
public class Config {
    ...
    @Property(type=Property.Type.BOOLEAN, name="Auto Simon-Says")
    ...
    @Property(type=Property.Type.BOOLEAN, name="Crystal Reach", note="Sneak to activate", warning=true)
    ...
    @Property(type=Property.Type.CHECKBOX, name="Gyrokinetic Wand", parent="Item Macros")
    ...
    @Property(type=Property.Type.CHECKBOX, name="Soul Whip w/ Anything", note="Whip whip nae nae", parent="Item Macros")
    public static boolean soulWhipWithAnything = false;
    @Property(type=Property.Type.BOOLEAN, name="Teleport w/ Anything", parent="Item Macros")
    ...
    @Property(type=Property.Type.BOOLEAN, name="Dungeon Map", note="based on IllegalMap by UnclaimedBloom6", beta=true)
    ...
    @Property(type=Property.Type.BOOLEAN, name="Assume Spirit Pet", parent="Dungeon Map")
    public static boolean assumeSpiritPet = false;
    @Property(type=Property.Type.BOOLEAN, name="Announce Score in Chat", parent="Dungeon Map")
    public static boolean announceScore = false;
    @Property(type=Property.Type.NUMBER, name="Specify Number", parent="Announce Score in Chat", min=230, max=300, step=10, prefix="Announce at ", suffix=" score")
    public static int announceScoreNumber = 300;
    @Property(type=Property.Type.SELECT, name="Specify Chat", parent="Announce Score in Chat", options={"Party Chat", "All Chat", "Guild Chat", "Message Reply"})
    ...
    @Property(type=Property.Type.SELECT, name="Significant Room Name Style", parent="Dungeon Map", options={"Short", "Full", "None"})
    ...
    @Property(type=Property.Type.BOOLEAN, name="Catgirls")
    public static boolean catGirls = false;
    @Property(type=Property.Type.SELECT, name="Cat-Mode", parent="Catgirls", options={"Girls", "Boys", "Bisexual", "Real Cats"})
    public static int catGirlsMode = 0;
    @Property(type=Property.Type.BOOLEAN, name="Auto Terminals", note="by 0Kelvin_")
    public static boolean autoTerminals = false;
    @Property(type=Property.Type.BOOLEAN, name="Pingless", note="Send clicks before window is updated", parent="Auto Terminals")
    public static boolean terminalPingless = false;
    @Property(type=Property.Type.NUMBER, name="Click Delay", parent="Auto Terminals", step=10, suffix="ms", min=50, max=1000)
    ...
    @Property(type=Property.Type.BOOLEAN, name="Send Anonymous Crash Reports", note="Improve ShadyAddons")
